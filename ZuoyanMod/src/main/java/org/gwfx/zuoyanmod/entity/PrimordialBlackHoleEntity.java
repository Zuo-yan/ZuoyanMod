...
public class PrimordialBlackHoleEntity extends Entity {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(DATA_VISUAL_RADIUS, (float) VISUAL_RADIUS);
    }
    ...
    @Override
    public void tick() {
        // 必须调 super：tickCount 在这里自增，客户端的动画进度（EntityRenderState.ageInTicks）
        // 就是拿 tickCount 算的，不调的话客户端拿不到时间轴，黑洞会僵在初始大小。
        super.tick();
