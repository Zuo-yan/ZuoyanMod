...
public final class MenuRegistry {
    ...
    public static final RegistryObject<MenuType<MicroHadronColliderMenu>> MICRO_HADRON_COLLIDER_MENU =
            MENUS.register("micro_hadron_collider",
                    () -> new MenuType<>(MicroHadronColliderMenu::new, net.minecraft.world.flag.FeatureFlags.DEFAULT_FLAGS));
